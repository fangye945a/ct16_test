...
export const MOCK_DEVICE_MODELS: IDeviceModel[] = [
  CreateBuiltinDeviceModel({
    ...
    interfaces: [{ name: 'COVI RS485 通信接口', identifier: 'coviRS485', type: 'RS485', defaultConfig: [-1, -1, 9600, 8, 1, 'N'], description: '数组依次表示槽位号、通道号、波特率、数据位、停止位和校验位；主板槽位 0 使用通道 1、2，子板从槽位 1 开始并使用通道 1、2' }],
  ...
  CreateBuiltinDeviceModel({
    ...
    interfaces: [
      { name: '开门控制', identifier: 'openDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号' },
      { name: '停止控制', identifier: 'stopDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号' },
      { name: '关门控制', identifier: 'closeDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号' },
  ...
  CreateBuiltinDeviceModel({
    ...
    interfaces: [
      { name: '正面绿灯控制', identifier: 'frontGreenCtrlDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号，槽位号范围 1-6，通道号范围 1-16' },
      { name: '正面红灯控制', identifier: 'frontRedCtrlDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号，槽位号范围 1-6，通道号范围 1-16' },
      { name: '反面绿灯控制', identifier: 'backGreenCtrlDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号，槽位号范围 1-6，通道号范围 1-16' },
      { name: '反面红灯控制', identifier: 'backRedCtrlDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号，槽位号范围 1-6，通道号范围 1-16' },
  ...
  CreateBuiltinDeviceModel({
    ...
    interfaces: [
      { name: '正面绿灯控制', identifier: 'frontGreenCtrlDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号' },
      { name: '正面红灯控制', identifier: 'frontRedCtrlDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号' },
      { name: '反面绿灯控制', identifier: 'backGreenCtrlDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号' },
      { name: '反面红灯控制', identifier: 'backRedCtrlDo', type: 'DO', defaultConfig: [-1, -1], description: '数组依次表示槽位号和通道号' },
